package com.hey.heys.ui.channel.edit.editDialog
...
import com.hey.heys.databinding.EditChannelPurposeDialogBinding
import com.hey.heys.enums.ChannelPurpose
import com.hey.heys.util.ChannelPreference

class EditChannelPurposeDialog() : DialogFragment() {
   private lateinit var binding: EditChannelPurposeDialogBinding
   private val viewModel by viewModels<EditChannelPurposeDialogViewModel>()
   private lateinit var listener: ChannelPurposeDialogOnClickListener

   override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
      binding = EditChannelPurposeDialogBinding.inflate(inflater, container, false)
