package com.hey.heys.ui.main.content.contestExtracurricular.contest.detail
...
import com.hey.heys.databinding.ContestShareBottomSheetBinding
...
class ContestShareBottomSheet : BottomSheetDialogFragment() {
   ...
   override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
      ...
      binding.btnClip.setOnClickListener {
         // TODO 링크 복사
         com.hey.heys.CustomSnackBar(requireParentFragment().requireView(), "공유 링크를 복사했어요!", null).show()
         dismiss()
      }
   }
