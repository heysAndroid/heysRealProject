package com.hey.heys.ui.login.sign_in.password
...
class SignInPasswordViewModel @Inject constructor(
   ...
   private val _response: MutableLiveData<com.hey.heys.Event<Response<Void>>> = MutableLiveData()
   val response: LiveData<com.hey.heys.Event<Response<Void>>> = _response
   ...
   fun login(username: String, password: String) {
      job = CoroutineScope(Dispatchers.IO + exceptionHandler).launch {
         _response.postValue(com.hey.heys.Event(signupRepository.loginApi(username, password)))
         /*
