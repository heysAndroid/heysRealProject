...
class CustomPagerAdapter : ListAdapter<String, CustomPagerAdapter.CustomItemViewHolder>(CustomDiffCallback) {
   ...
   inner class CustomItemViewHolder(private val binding: CustomPagerItemViewBinding) : RecyclerView.ViewHolder(binding.root) {
      fun bind(text: String) {
         // text 바꿔주기
         binding.intro.text = text
      }
   }

   object CustomDiffCallback : DiffUtil.ItemCallback<String>() {
